...
<dl markdown="1">
<dt>How do you debug an app once it has been compiled to JavaScript?</dt>
<dd>
...
<dt>How can I write Dart code that compiles to performant JavaScript?</dt>
<dd>
...
<dt>How are floating point numbers handled when compiled to JavaScript?</dt>
<dd>
...
<dt>How are integers handled when compiled to JavaScript?</dt>
<dd>
...
<dt>How are typed lists handled when compiled to JavaScript?</dt>
<dd>
...
<dt>What browsers do you support as JavaScript compilation targets?</dt>
<dd markdown="1">
...
<dt>Why doesn't Dart support IE9 or earlier?</dt>
<dd>
...
Also,d art2js can emit efficient code if it assumes a modern browser with
ECMAScript5 or greater features.
</dd>

<dt>Is Dart supported by my browser?</dt>
<dd>
...
<dt>Will the Dart VM get into Chrome?</dt>
<dd markdown="1">
...
<dt>Why is the code for "Hello, World" so big, compared to the original
    Dart code after compilation to JavaScript?</dt>
<dd markdown="1">
...
<dt>How do I debug Dart code after it's been compiled to JavaScript?</dt>
<dd markdown="1">
...
<dt>Will any valid Dart code compile to JavaScript, or are there limitations?</dt>
<dd>
...
<dt>How can dart2js produce JavaScript that runs faster than handwritten JavaScript?</dt>
<dd>
...
<dt>Why not compile Dart to asm.js instead of building a specialized VM?</dt>
<dd markdown="1">
...
**Compilation of a Dart applicaton to asm.js**
...
<dt>How does Dart code interoperate with JavaScript libraries?</dt>
<dd markdown="1">
...
<dt>I have a large JavaScript codebase. How can I migrate it to Dart?</dt>
<dd markdown="1">
...
<dt>I have a large application written in GWT. How do I port it to Dart?</dt>
<dd markdown="1">
...
<dt>Is the language what really needs to be fixed in web development?</dt>
<dd markdown="1">
...
<dt>Is Dart going to divert community effort from JavaScript-based web development?</dt>
<dd>
...
<dt>Does Google want to replace JavaScript with Dart?</dt>
<dd>
...
<dt>Isn't Dart a lot like JavaScript?</dt>
<dd markdown="1">
...
<dt>How does Dart compare with usng the Closure compiler on JavaScript?</dt>
<dd markdown="1">
...
<dt>How does Dart compare with CoffeeScript?</dt>
<dd>
...
<dt>What does Google think of TypeScript?</dt>
<dd markdown="1">
