...
description: "Standards-based web components: custom elements, templates,
and data binding for Dart web apps. A Dart port of Polymer."
permalink: /polymer-old/
---
...
Learn more at
[Imports and Your App's Directory Structure](app-directories).
...
Learn more about [pub build](/tools/pub/pub-build).
...
Keep an eye on this page and the [FAQ](faq)
